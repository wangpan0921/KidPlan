...
public class MainActivity3 extends BaseActivity implements
    ...
    protected void initView() {
        ...
        findViewById(R.id.iv_more).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mMoreDialog == null) {
                    mMoreDialog = new AlertDialog.Builder(MainActivity3.this)
                            .setTitle(R.string.list_dialog_title)
                            .setItems(R.array.list_dialog_items, MainActivity3.this)
                            .create();
                }
                mMoreDialog.show();
            }
...
//                                        mCalendarView.getCurYear(), mCalendarView.getCurMonth(), 23);
        ...
        findViewById(R.id.iv_func).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mFuncDialog == null) {
                    mFuncDialog = new AlertDialog.Builder(MainActivity3.this)

...
public class MainActivity2 extends BaseActivity {
    ...
    protected void initView() {
        ...
        mCalendarView.setOnCalendarSelectListener(new CalenderSelectListener());
        mCalendarView.setOnYearChangeListener(new YearChangeListener());
    ...
    class CalenderSelectListener implements CalendarView.OnCalendarSelectListener {
    ...
    class YearChangeListener implements CalendarView.OnYearChangeListener {
